...
class BertugasDetailAppr extends StatefulWidget{
  final String getLemburCode;
  final String getKaryawanNo;

  const BertugasDetailAppr(this.getLemburCode,this.getKaryawanNo);
  @override
  _BertugasDetailAppr createState() => _BertugasDetailAppr();
}

class _BertugasDetailAppr extends State<BertugasDetailAppr> {
