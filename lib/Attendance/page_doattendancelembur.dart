...
class ClockOutLembur extends StatefulWidget {
  ...
  const ClockOutLembur(this.getKaryawanNo, this.getJam, this.getNamaHari,this.getNote,this.getType,
  ...
  @override
  _ClockOutLembur createState()=> _ClockOutLembur();
}


class _ClockOutLembur extends State<ClockOutLembur> {
  ...
  _add_attendance() async {
    await m_helper().add_attendancelembur(widget.getKaryawanNo, widget.getNamaHari,
  ...
  Widget build(BuildContext context) {
    return WillPopScope(child: Scaffold(
      appBar: new AppBar(
        ...
        elevation: 1,
        title: Text(
          widget.getType.toString()+ " Lembur", style: GoogleFonts.montserrat(fontSize: 17,fontWeight: FontWeight.bold,color: Colors.black),),
        leading: Builder(
