                        ...
                        children: [
                          ...
                          Container(
                              ...
                              child:InkWell(
                                ...
                                child:  ListTile(
                                  title: Text(
                                    getBahasa.toString() == '1' ?
                                    "PIN kamu masih default" : "You Have Default PIN",
                                    style: GoogleFonts.montserrat(color: Colors.black,fontWeight: FontWeight.bold,
                                        fontSize: 15),),
                                  subtitle: Text(
                                      getBahasa.toString() == '1' ?
                                      "Ayo ganti PIN kamu untuk keamanan lebih" :
                          ...
                          Wrap(
                            ...
                            /*  Container(
                                ...
                                InkWell(
                                onTap: (){
                                  Navigator.push(context, ExitPage(page: PageReqAttend(widget.getKaryawanNo, widget.getKaryawanNama, widget.getKaryawanEmail))).then(onGoBack2);
                                },
                                child:Column(
                                  children: [
                                    Container(
                                    ...
                                    Padding(padding: const EdgeInsets.only(top:8),
                                      child: Text(getBahasa.toString() == '1' ? "Permintaan":"Request", style: GoogleFonts.nunito(fontSize: 13),textAlign: TextAlign.center,),)
                                  ],
                                ),
                              )),*/
                                ...
                                child:  InkWell(
                                  ...
                                  child:Column(
                                    children: [
                                      ...
                                      Padding(padding: const EdgeInsets.only(top:8),
                                        child: Text("Reimburs", style: GoogleFonts.nunito(fontSize: 13),textAlign: TextAlign.center,),)
                                    ],
                                  ),
                                ),
                              )),
                                ...
                                child:  InkWell(
                                  ...
                                  child:Column(
                                    children: [
                                      ...
                                      Padding(padding: const EdgeInsets.only(top:8),
                                        child: Text(getBahasa.toString() == '1' ? "Tim Saya":"My Teams", style: GoogleFonts.nunito(fontSize: 13),textAlign: TextAlign.center,),)
                                    ],
                                  ),
                                ),
                              )),
                                ...
                                child:  InkWell(
                                  ...
                                  child:Column(
                                    children: [
                                      ...
                                      Padding(padding: const EdgeInsets.only(top:8),
                                        child: Text(getBahasa.toString() == '1' ? "Aset saya":"My Assets", style: GoogleFonts.nunito(fontSize: 13),textAlign: TextAlign.center,),)
                                    ],
                                  ),
                                ),
                              )),*/
