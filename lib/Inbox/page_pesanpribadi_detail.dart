...
class PagePesanPribadiDetail extends StatefulWidget{
  final String getTittle;
  final String getMessage;
  final String getDate;
  final String getMessageID;
  final String getAttachment;
  const PagePesanPribadiDetail(this.getTittle, this.getMessage, this.getDate, this.getMessageID, this.getAttachment);
  @override
  _PagePesanPribadiDetail createState() => _PagePesanPribadiDetail();
}


class _PagePesanPribadiDetail extends State<PagePesanPribadiDetail> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(child: Scaffold(
      appBar: AppBar(
        ...
        title: Text(getBahasa.toString() == "1" ? 'Detail Pesan' : 'Message Detail', style: GoogleFonts.montserrat(fontSize: 17,fontWeight: FontWeight.bold,color: Colors.black),),
        elevation: 1,
        leading: Builder(
