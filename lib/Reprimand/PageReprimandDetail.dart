...
class PageReprimandDetail extends StatefulWidget{
  final String getTittle;
  final String getMessage;
  final String getDate;
  final String getMessageID;
  final String getAttachment;
  const PageReprimandDetail(this.getTittle, this.getMessage, this.getDate, this.getMessageID, this.getAttachment);
  @override
  _PageReprimandDetail createState() => _PageReprimandDetail();
}


class _PageReprimandDetail extends State<PageReprimandDetail> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(child: Scaffold(
      appBar: AppBar(
        ...
        title: Text(getBahasa.toString() == "1" ? 'Detail Teguran' : 'Reprimand Detail', style: GoogleFonts.montserrat(fontSize: 17,fontWeight: FontWeight.bold,color: Colors.black),),
        elevation: 1,
        leading: Builder(
