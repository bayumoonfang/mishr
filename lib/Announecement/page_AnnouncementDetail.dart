...
class PageAnnounecementDetail extends StatefulWidget{
  final String getTittle;
  final String getMessage;
  final String getDate;
  final String getMessageID;
  final String getAttachment;
  const PageAnnounecementDetail(this.getTittle, this.getMessage, this.getDate, this.getMessageID, this.getAttachment);
  @override
  _PageAnnounecementDetail createState() => _PageAnnounecementDetail();
}


class _PageAnnounecementDetail extends State<PageAnnounecementDetail> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(child: Scaffold(
      appBar: AppBar(
        ...
        title: Text(getBahasa.toString() == "1" ? 'Detail Informasi' : 'Announecement Detail', style: GoogleFonts.montserrat(fontSize: 17,fontWeight: FontWeight.bold,color: Colors.black),),
        elevation: 1,
        leading: Builder(
          ...
          children: [
            ...
            Align(
              ...
              child: Padding(
                ...
                child: Text(widget.getMessage, style: GoogleFonts.workSans(fontSize: 14,color: Colors.black,height: 1.8,wordSpacing: 2),),
              ),
            )
          ],
        ),
