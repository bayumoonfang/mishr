...
import 'package:abzeno/Announecement/page_AnnouncementDetail.dart';
...
import 'S_HELPER/g_announcement.dart';



class PageAnnouncement extends StatefulWidget{
  final String getKaryawanNo;
  const PageAnnouncement(this.getKaryawanNo);
  @override
  _PageAnnouncement createState() => _PageAnnouncement();
}


class _PageAnnouncement extends State<PageAnnouncement> {
  ...
  Future getData() async {
    setState(() {
      g_announecement().getData_Announecement(filter);
    });
  }
          ...
          title: Container(
            ...
            child: TextFormField(
              ...
              decoration: new InputDecoration(
                ...
                hintText: getBahasa.toString() == "1"? 'Cari Informasi...' : 'Search Announcement...',
              ),
            ),
          ),        leading: Builder(
                ...
                Expanded(
                    child: RefreshIndicator(
                      ...
                      child: Padding(
                        ...
                        child: FutureBuilder(
                            future: g_announecement().getData_Announecement(filter),
                                              ...
                                              children: [
                                                InkWell(
                                                  ...
                                                  onTap: (){
                                                    ...
                                                    Navigator.push(context, ExitPage(page: PageAnnounecementDetail(
                                                        ...
                                                        snapshot.data![i]["f"].toString()))).then(onGoBack);
                                                  },
                                                ),
