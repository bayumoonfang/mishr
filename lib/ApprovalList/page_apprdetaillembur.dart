...
class _ApprLemburDetail extends State<ApprLemburDetail> {
  ...
  _lembur_approve() async {
    Navigator.pop(context);
    setState(() {
      _isPressedHUD = true;
      _isPressedBtn = false;
    });
    await m_lembur().lembur_approve(widget.getLemburCode, widget.getKaryawanNo).then((value){
      if(value[0] == 'ConnInterupted'){
        getBahasa.toString() == "1"?
        AppHelper().showFlushBarsuccess(context, "Koneksi terputus...") :
        AppHelper().showFlushBarsuccess(context, "Connection Interupted...");
  ...
  showDialog1(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      TextAlign.center,),
      content: Text(getBahasa.toString() == "1"?  "Apakah anda yakin menyetujui permintaan ini sebagai persetujuan 2 ?": "Would you like to continue approve this request as Approval 2 ?", style: GoogleFonts.varelaRound(),textAlign:
      TextAlign.center,),
      actions: [
        cancelButton,
        continueButton,
  ...
  showDialogReject1(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Text(getBahasa.toString() == "1"?  "Apakah anda yakin menolak permintaan ini sebagai persetujuan 2 ?":
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                lembur_status.toString() != 'Fully Approved' ?
                Padding(padding: const EdgeInsets.only(top: 10,bottom: 15),
                    child : Container(
                        ...
                        child:  ListTile(
                          ...
                          title:Text(getBahasa.toString() == "1"? "Hubungi HRD jika ingin membatalkan permintaan ini" : "Contact HRD if you want to cancel this request",
                ...
                Padding(
                    ...
                    child: Align(alignment: Alignment.centerLeft,
                      child: Text(getBahasa.toString() == "1"? "Info Lembur" : "Overtime Info", style: GoogleFonts.montserrat(fontSize: 15,fontWeight: FontWeight.bold)),)),
                    ...
                    child: Align(alignment: Alignment.centerLeft,
                      ...
                      Table(
                          ...
                          children: [
                            ...
                            TableRow(children :[
                              Padding(padding: EdgeInsets.only(bottom: 5),
                                child: Text(getBahasa.toString() == "1"? 'Delegasi Ke' : 'Delegate to', style: GoogleFonts.nunito(fontSize: 14) ),),
                              Padding(padding: EdgeInsets.only(bottom: 5),
                                child: Text(lembur_delegatetoname.toString(), style: GoogleFonts.nunito(fontSize: 14) ),),
                            ]),
                          ]
                      ),
                    )),
                ...
                Padding(
                    ...
                    child: Align(alignment: Alignment.centerLeft,
                      child: Text(getBahasa.toString() == "1"? "Deskripsi Lembur" : "Overtime Description", style: GoogleFonts.montserrat(fontSize: 15,fontWeight: FontWeight.bold)),)),
