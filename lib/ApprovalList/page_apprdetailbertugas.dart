...
class ApprBertugasDetail extends StatefulWidget{
  final String getLemburCode;
  final String getKaryawanNo;

  const ApprBertugasDetail(this.getLemburCode,this.getKaryawanNo);
  @override
  _ApprBertugasDetail createState() => _ApprBertugasDetail();
}

class _ApprBertugasDetail extends State<ApprBertugasDetail> {
  ...
  _get_BertugasDetail() async {
    await g_bertugas().get_BertugasDetail2(
  ...
  _bertugas_apprv(getAppr) async {
    setState(() {
      _isPressedBtn = false;
      _isPressedHUD = true;
      if(getAppr== "1") {
        fcm_message =  getBahasa.toString() == "1" ? "Pengajuan bertugas telah disetujui oleh atasan anda sebagai approval 1" :
        "LEAVE has been approved by your supervisor as approval 1.";
        fcm_message2 =  getBahasa.toString() == "1" ? "Terdapat pengajuan bertugas yang membutuhkan approval anda, "
        ...
        fcm_message =  getBahasa.toString() == "1" ? "Pengajuan bertugas anda telah sepenuhnya disetujui" :
    ...
    await m_bertugas().bertugas_approved(bertugas_no, widget.getKaryawanNo, getAppr, fcm_message, fcm_message2).then((value){
      if(value[0] == 'ConnInterupted'){
        getBahasa.toString() == "1"?
        AppHelper().showFlushBarsuccess(context, "Koneksi terputus...") :
        AppHelper().showFlushBarsuccess(context, "Connection Interupted...");
        ...
        setState(() {
          if(value[0] != '') {
            ...
            if(value[0] == '1') {
              ...
              SchedulerBinding.instance?.addPostFrameCallback((_) {
                getBahasa.toString() == "1"?
                AppHelper().showFlushBarconfirmed(context, "Pengajuan bertugas berhasil disetujui")
                    :
  ...
  _bertugas_reject(getAppr) async {
    setState(() {
      _isPressedBtn = false;
      _isPressedHUD = true;
      if(getAppr== "1") {
        fcm_message =  getBahasa.toString() == "1" ? "Pengajuan bertugas anda telah ditolak oleh atasan anda sebagai approval 1" :
        "LEAVE has been rejected by your supervisor as approval 1.";
        fcm_message2 =  "";
      } else {
        fcm_message =  getBahasa.toString() == "1" ? "Pengajuan bertugas anda telah ditolak oleh atasan anda sebagai approval 2" :
    ...
    await m_bertugas().bertugas_rejected(bertugas_no, widget.getKaryawanNo, getAppr, fcm_message, fcm_message2).then((value){
      if(value[0] == 'ConnInterupted'){
        getBahasa.toString() == "1"?
        AppHelper().showFlushBarsuccess(context, "Koneksi terputus...") :
        AppHelper().showFlushBarsuccess(context, "Connection Interupted...");
        ...
        setState(() {
          if(value[0] == '1') {
            ...
            SchedulerBinding.instance?.addPostFrameCallback((_) {
              getBahasa.toString() == "1"?
              AppHelper().showFlushBarconfirmed(context, "Pengajuan bertugas berhasil ditolak")
                  :
          ...
          child: Container(
              ...
              child: Wrap(
                ...
                children: [
                  ...
                  //APPROVAL 2 ====================================
                  bertugas_appr2.toString() == widget.getKaryawanNo && bertugas_appr2_status.toString() == 'Waiting Approval' &&
