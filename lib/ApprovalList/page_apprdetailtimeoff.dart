...
import '../Time Off/S_HELPER/m_timeoff.dart';
import '../Time Off/page_detailactivitytimeoff.dart';
import '../Time Off/page_timeoffapprovedetail.dart';



class ApprTimeOffDetail extends StatefulWidget{
  final String getTimeOffCode;
  final String getKaryawanNo;
  final String getKaryawanNama;
  const ApprTimeOffDetail(this.getTimeOffCode,this.getKaryawanNo, this.getKaryawanNama);
  @override
  _ApprTimeOffDetail createState() => _ApprTimeOffDetail();
}
        ...
        bottomSheet: Visibility(
          ...
          child: Container(
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  EasyLoading.show(status: AppHelper().loading_text);
                  Navigator.push(context, ExitPage(page: TimeOffApproveDetail(widget.getTimeOffCode, widget.getKaryawanNo, widget.getKaryawanNama,"2")));
                },
              )
          ),
        )
